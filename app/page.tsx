      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <aside className="hidden md:block">
          <div className="sticky top-4 space-y-4">
            <div className="w-full h-[250px] bg-gray-100 border rounded-lg flex items-center justify-center text-gray-500">
              광고 (250×250)
            </div>
            <div className="w-full h-[600px] bg-gray-100 border rounded-lg flex items-center justify-center text-gray-500">
              광고 (300×600)
            </div>
          </div>
        </aside>
